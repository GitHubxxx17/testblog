...
const Route0 = React3.lazy(() => __vitePreload(() => import("./helloworld-Bib_jObG.js"), true ? [] : void 0));
const routes = [
  { path: "/post/helloworld", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./helloworld-Bib_jObG.js"), true ? [] : void 0) }
];
const siteData = { "title": "fispo的个人博客", "description": "学无止境", "theme": "particle", "themeConfig": { "navMenus": [{ "title": "首页", "path": "/", "icon": "home" }, { "title": "标签", "path": "/tag", "icon": "tag" }, { "title": "分类", "path": "/category", "icon": "folder-open" }, { "title": "关于", "path": "/about", "icon": "heart" }], "banner": { "img": "/banner.jpg", "title": "", "subTitle": "" } }, "vite": {}, "author": "fispo", "avatar": "/avatar.jpg", "backgroundImg": "/bg.png", "root": "docs", "postDir": "post", "public": "public", "notFoundImg": "/404.png", "logo": "/logo.png" };
