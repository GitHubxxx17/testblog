...
const Route0 = React3.lazy(() => __vitePreload(() => import("./HTTP-BhRF-NNA.js"), true ? [] : void 0));
const Route1 = React3.lazy(() => __vitePreload(() => import("./MySQL-dPp3unkI.js"), true ? [] : void 0));
const Route2 = React3.lazy(() => __vitePreload(() => import("./node.js-BVe5ij49.js"), true ? [] : void 0));
const Route3 = React3.lazy(() => __vitePreload(() => import("./vue3笔记（四）-BhZJK_HJ.js"), true ? [] : void 0));
const Route4 = React3.lazy(() => __vitePreload(() => import("./vue笔记（一）-BsatjFqp.js"), true ? [] : void 0));
const Route5 = React3.lazy(() => __vitePreload(() => import("./vue笔记（三）-B1_6_fA1.js"), true ? [] : void 0));
const Route6 = React3.lazy(() => __vitePreload(() => import("./vue笔记（二）-BDVvESa3.js"), true ? [] : void 0));
const Route7 = React3.lazy(() => __vitePreload(() => import("./搭建云服务器-C9KChQ-1.js"), true ? [] : void 0));
const Route8 = React3.lazy(() => __vitePreload(() => import("./数组sort()详解-CkIW0SKf.js"), true ? [] : void 0));
const routes = [
  { path: "/fispo/post/HTTP", element: React3.createElement(Route0), preload: () => __vitePreload(() => import("./HTTP-BhRF-NNA.js"), true ? [] : void 0) },
  { path: "/fispo/post/MySQL", element: React3.createElement(Route1), preload: () => __vitePreload(() => import("./MySQL-dPp3unkI.js"), true ? [] : void 0) },
  { path: "/fispo/post/node", element: React3.createElement(Route2), preload: () => __vitePreload(() => import("./node.js-BVe5ij49.js"), true ? [] : void 0) },
  { path: "/fispo/post/vue3%E7%AC%94%E8%AE%B0%EF%BC%88%E5%9B%9B%EF%BC%89", element: React3.createElement(Route3), preload: () => __vitePreload(() => import("./vue3笔记（四）-BhZJK_HJ.js"), true ? [] : void 0) },
  { path: "/fispo/post/vue%E7%AC%94%E8%AE%B0%EF%BC%88%E4%B8%80%EF%BC%89", element: React3.createElement(Route4), preload: () => __vitePreload(() => import("./vue笔记（一）-BsatjFqp.js"), true ? [] : void 0) },
  { path: "/fispo/post/vue%E7%AC%94%E8%AE%B0%EF%BC%88%E4%B8%89%EF%BC%89", element: React3.createElement(Route5), preload: () => __vitePreload(() => import("./vue笔记（三）-B1_6_fA1.js"), true ? [] : void 0) },
  { path: "/fispo/post/vue%E7%AC%94%E8%AE%B0%EF%BC%88%E4%BA%8C%EF%BC%89", element: React3.createElement(Route6), preload: () => __vitePreload(() => import("./vue笔记（二）-BDVvESa3.js"), true ? [] : void 0) },
  { path: "/fispo/post/%E6%90%AD%E5%BB%BA%E4%BA%91%E6%9C%8D%E5%8A%A1%E5%99%A8", element: React3.createElement(Route7), preload: () => __vitePreload(() => import("./搭建云服务器-C9KChQ-1.js"), true ? [] : void 0) },
  { path: "/fispo/post/%E6%95%B0%E7%BB%84sort()%E8%AF%A6%E8%A7%A3", element: React3.createElement(Route8), preload: () => __vitePreload(() => import("./数组sort()详解-CkIW0SKf.js"), true ? [] : void 0) }
];
const siteData = { "base": "/fispo", "title": "XXX17的个人博客", "description": "学无止境", "theme": "", "themeConfig": { "navMenus": [{ "title": "首页", "path": "/", "icon": "home" }, { "title": "标签", "path": "/tag", "icon": "tag" }, { "title": "分类", "path": "/category", "icon": "folder-open" }, { "title": "关于", "path": "/about", "icon": "heart" }], "banner": { "img": "/banner.png", "subtitle": "" }, "sidebar": { "enable": true, "hide": false, "position": "right", "card_author": { "enable": true, "description": "", "button": { "enable": true, "icon": "github", "text": "Follow me", "link": "" } }, "card_announcement": { "enable": true, "content": "" }, "card_recent_post": { "enable": true, "limit": 5, "sort": "date" }, "card_categories": { "enable": true, "limit": 10 }, "card_tags": { "enable": true, "limit": 10 }, "card_webinfo": { "enable": true, "post_count": true, "last_push_date": true, "run_time": true } }, "footer": { "message": "", "copyright": "" } }, "vite": { "base": "/fispo" }, "author": "XXX17", "avatar": "/avatar.jpg", "backgroundImg": "/bg.png", "root": "docs", "postDir": "post", "public": "public", "notFoundImg": "/404.png", "logo": "/logo.png", "markdown": {}, "plugins": [{ "name": "fispo:plugin-perloader", "alias": { "@plugin-perloader": "D:\\Front-end\\fispo\\packages\\plugin-preloader\\src\\Loading\\index.tsx" }, "preloader": "@plugin-perloader" }], "preloader": true };
...
function removeBase$1(url, base) {
  const normalizedBase = normalizeSlash(base);
  return url.replace(normalizedBase, "");
}
async function handleRoutes(routes2, base) {
  const articlesList = [];
  const tags = {};
  const categories = {};
  for await (const route of routes2) {
    ...
    articlesList.push({
      ...
      path: removeBase$1(route.path, base),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$c.articleList, children: currentArtcleList.map((item2, index) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$c.item, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$c.left, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: item2.path, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item2.cover, alt: "" }) }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6["card-article"], children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: styles$6.list, children: props == null ? void 0 : props.data.map((item2, index) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.left, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: item2.path, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item2.cover, alt: "" }) }) }),
...
function ArticleLayout(props) {
  ...
  const copyrightText = reactExports.useMemo(() => {
    ...
    return [
      { meta: "文章作者：", value: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { href: "", children: author2 }) },
      {
        meta: "文章链接：",
